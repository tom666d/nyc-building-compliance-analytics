...
- Python can authenticate from the local machine;
- real NYC Open Data rows have been loaded into the raw tables;
- dbt models build successfully against the cloud account;
- scheduled orchestration and continuous integration can authenticate non-interactively.
